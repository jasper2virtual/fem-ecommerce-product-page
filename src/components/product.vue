    ...
    <div class="product-wrapper">
        ...
        app-desktop:col-span-6 app-desktop:max-w-[445px]">
            ...
            ">
                ...
                <button
                    class="bg-[#FF7E1B] text-black rounded p-4 flex gap-4 justify-center shadow-2xl shadow-[#FFC599]
                    app-desktop:grow-[3]
                    "
